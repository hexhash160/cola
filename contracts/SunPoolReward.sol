...
contract SunPoolReward is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public sun = IERC20(0x416B5151320359EC18B08607C70A3B7439AF626AA3);
    uint256 public constant DURATION = 7 days;

    uint256 public initreward = 3500*1e18;
    uint256 public starttime = 1601510400;
    ...
    modifier checkhalve(){
        if (block.timestamp >= periodFinish) {
            ...
            sun.mint(address(this),initreward);
